...
Total unrouted pairs: 49

| Net | Ratsnest pairs | Layout note |
|---|---:|---|
| `BQ_SYS` | 5 | Route as system power pour after charger/boost placement review. |
...
| `SOLAR_FUSED` | 2 | Route with solar protection power path after Q1/U4 placement review. |
| `USB_VBUS_RAW` | 2 |  |
| `BATP_KELVIN` | 1 |  |
| `BOOST_COMP` | 1 |  |
| `BOOST_FB` | 1 |  |
