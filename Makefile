...
.PHONY: validate generate-capture generate-placement generate-routes erc drc check-reports summarize-unrouted summarize-sourcing export-draft-quote kicad-checks full-check layout-status status
